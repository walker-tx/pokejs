 ...
 */
declare class PokeSdkHttpError extends Error {
    status: number;
    message: string;
 ...
 */
declare class PokeSdkClientError extends Error {
    message: string;
 ...
 * }
 */
declare function getGenerationByName(name: string): Promise<Result<Generation, PokeSdkClientError | PokeSdkHttpError>>;
/**
 ...
 */
declare function getGenerationById(id: number): Promise<Result<Generation, PokeSdkHttpError>>;
/**
 ...
 */
declare function listGenerations(): Promise<Result<NamedAPIResourceList, PokeSdkHttpError>>;
 ...
 */
declare function getPokemonByName(name: string): Promise<Result<Pokemon, PokeSdkClientError | PokeSdkHttpError>>;
/**
 ...
 * @see https://pokeapi.co/docs/v2#pokemon
 */
declare function getPokemonById(id: number): Promise<Result<Pokemon, PokeSdkHttpError>>;
/**
 ...
 * @see https://pokeapi.co/docs/v2#named
 */
declare function listPokemon(): Promise<Result<NamedAPIResourceList, PokeSdkHttpError>>;
...
export { type APIResource, type Ability, type AbilityEffectChange, type AbilityEffectEntry, type AbilityFlavorTextEntry, type AbilityName, type AbilityPokemon, type AffectingMoves, type AffectingMovesDecrease, type AffectingMovesIncrease, type AffectingNaturesDecrease, type AffectingNaturesIncrease, type Animated, type AwesomeName, type Berry, type BerryElement, type BerryFirmness, type BerryFirmnessName, type BerryFlavor, type BerryFlavorName, type BlackWhite, type Chain, type ChainEvolvesTo, type Characteristic, type CharacteristicDescription, type ContestCombos, type ContestEffect, type ContestEffectEffectEntry, type ContestEffectFlavorTextEntry, type ContestType, type ContestTypeName, type Crystal, type DiamondPearl, type DreamWorld, type EggGroup, type EggGroupName, type Emerald, type EncounterCondition, type EncounterConditionName, type EncounterConditionValue, type EncounterConditionValueName, type EncounterMethod, type EncounterMethodName, type EncounterMethodRate, type EncounterMethodRateVersionDetail, type EvolutionChain, type EvolutionTrigger, type EvolutionTriggerName, type EvolvesToEvolvesTo, type FireredLeafgreen, type Flavor, type FluffyEffectEntry, type FluffyEncounterDetail, type FluffyEvolutionDetail, type FormDescription, type FormName, type Gender, type Generation, type GenerationI, type GenerationIi, type GenerationIii, type GenerationIv, type GenerationName, type GenerationV, type GenerationVi, type GenerationVii, type GenerationViiIcons, type GenerationViii, type GenerationViiiIcons, type Genus, type Gold, type GrowthRate, type GrowthRateDescription, type HeartgoldSoulsilver, type HeldByPokemon, type HeldByPokemonVersionDetail, type HeldItem, type HeldItemVersionDetail, type Home, type Item, type ItemAttribute, type ItemAttributeDescription, type ItemAttributeName, type ItemCategory, type ItemCategoryName, type ItemEffectEntry, type ItemFlavorTextEntry, type ItemFlingEffect, type ItemFlingEffectEffectEntry, type ItemGameIndex, type ItemMachine, type ItemName, type ItemPocket, type ItemPocketName, type ItemSprites, type Language, type LanguageName, type Level, type ListEndpointOptions, type Location, type LocationArea, type LocationAreaName, type LocationAreaPokemonEncounter, type LocationGameIndex, type LocationName, type Machine, type Meta, type Move, type MoveAilment, type MoveAilmentName, type MoveBattleStyle, type MoveBattleStyleName, type MoveBattleStylePreference, type MoveCategory, type MoveCategoryDescription, type MoveDamageClass, type MoveDamageClassDescription, type MoveDamageClassName, type MoveEffectChange, type MoveEffectEntry, type MoveElement, type MoveFlavorTextEntry, type MoveLearnMethod, type MoveLearnMethodDescription, type MoveLearnMethodName, type MoveMachine, type MoveName, type MoveTarget, type MoveTargetDescription, type MoveTargetName, type NamedAPIResource, type NamedAPIResourceList, type Nature, type NatureName, type Normal, type OfficialArtwork, type OmegarubyAlphasapphire, type Other, type PalParkArea, type PalParkAreaName, type PalParkAreaPokemonEncounter, type PalParkEncounter, type PastAbility, type PastAbilityAbility, type PastDamageRelation, type PastDamageRelationDamageRelations, type PastType, type PastTypeType, type PastValue, type PastValueEffectEntry, type Platinum, type PokeAPIOptions, PokeJS, type PokeathlonStat, type PokeathlonStatAffectingNatures, type PokeathlonStatChange, type PokeathlonStatName, type Pokedex, type PokedexDescription, type PokedexName, type PokedexNumber, type Pokemon, type PokemonAbility, type PokemonColor, type PokemonColorName, type PokemonEncounter, type PokemonEncounterVersionDetail, type PokemonEncounterVersionDetailObject, type PokemonEntry, type PokemonForm, type PokemonFormName, type PokemonFormSprites, type PokemonFormType, type PokemonGameIndex, type PokemonHabitat, type PokemonHabitatName, type PokemonShape, type PokemonShapeName, type PokemonSpecies, type PokemonSpeciesDetail, type PokemonSpeciesFlavorTextEntry, type PokemonSpeciesName, type PokemonSprites, type PokemonType, type PurpleEffectEntry, type PurpleEncounterDetail, type PurpleEvolutionDetail, type RedBlue, type Region, type RegionName, type RubySapphire, type Showdown, type Silver, type Stat, type StatAffectingNatures, type StatChange, type StatElement, type StatName, type Super, type SuperContestEffect, type SuperContestEffectFlavorTextEntry, type SuperContestEffectList, type Type, type TypeDamageRelations, type TypeGameIndex, type TypeName, type TypePokemon, type UltraSunUltraMoon, type Variety, type Version, type VersionGroup, type VersionGroupDetail, type VersionName, type Versions, type XY, type Yellow, getGenerationById, getGenerationByName, getPokemonById, getPokemonByName, listGenerations, listPokemon };
