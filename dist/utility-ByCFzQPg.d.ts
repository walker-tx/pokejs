...
interface PokeAPIOptions {
    ...
    limit?: number;
    /** T
     * he timeout of a response in milliseconds */
...
type PaginatedResult<TValue, TError> = {
    ok: false;
    error: TError;
} | {
    ok: true;
...
export { type HeldByPokemonVersionDetail as $, type APIResource as A, type Berry as B, type Characteristic as C, type Chain as D, type EggGroup as E, type Flavor as F, type ChainEvolvesTo as G, type PurpleEvolutionDetail as H, type EvolvesToEvolvesTo as I, type FluffyEvolutionDetail as J, type EvolutionTrigger as K, type EvolutionTriggerName as L, type Gender as M, type NamedAPIResource as N, type PokemonSpeciesDetail as O, type PurpleEffectEntry as P, type Generation as Q, type GenerationName as R, type SuperContestEffectList as S, type GrowthRate as T, type GrowthRateDescription as U, type Level as V, type Item as W, type ItemEffectEntry as X, type ItemFlavorTextEntry as Y, type ItemGameIndex as Z, type HeldByPokemon as _, type NamedAPIResourceList as a, type AffectingNaturesDecrease as a$, type ItemMachine as a0, type ItemName as a1, type ItemSprites as a2, type ItemAttribute as a3, type ItemAttributeDescription as a4, type ItemAttributeName as a5, type ItemCategory as a6, type ItemCategoryName as a7, type ItemFlingEffect as a8, type ItemFlingEffectEffectEntry as a9, type PastValue as aA, type PastValueEffectEntry as aB, type StatChange as aC, type MoveAilment as aD, type MoveAilmentName as aE, type MoveBattleStyle as aF, type MoveBattleStyleName as aG, type MoveCategory as aH, type MoveCategoryDescription as aI, type MoveDamageClass as aJ, type MoveDamageClassDescription as aK, type MoveDamageClassName as aL, type MoveLearnMethod as aM, type MoveLearnMethodDescription as aN, type MoveLearnMethodName as aO, type MoveTarget as aP, type MoveTargetDescription as aQ, type MoveTargetName as aR, type Nature as aS, type MoveBattleStylePreference as aT, type NatureName as aU, type PokeathlonStatChange as aV, type PalParkArea as aW, type PalParkAreaName as aX, type PalParkAreaPokemonEncounter as aY, type PokeathlonStat as aZ, type PokeathlonStatAffectingNatures as a_, type ItemPocket as aa, type ItemPocketName as ab, type Language as ac, type LanguageName as ad, type Location as ae, type LocationGameIndex as af, type LocationName as ag, type LocationArea as ah, type EncounterMethodRate as ai, type EncounterMethodRateVersionDetail as aj, type LocationAreaName as ak, type LocationAreaPokemonEncounter as al, type PokemonEncounterVersionDetail as am, type PurpleEncounterDetail as an, type Machine as ao, type Move as ap, type ContestCombos as aq, type Normal as ar, type Super as as, type MoveEffectChange as at, type FluffyEffectEntry as au, type MoveEffectEntry as av, type MoveFlavorTextEntry as aw, type MoveMachine as ax, type Meta as ay, type MoveName as az, type Ability as b, type PokemonHabitatName as b$, type AffectingNaturesIncrease as b0, type PokeathlonStatName as b1, type Pokedex as b2, type PokedexDescription as b3, type PokedexName as b4, type PokemonEntry as b5, type PokemonEncounter as b6, type PokemonEncounterVersionDetailObject as b7, type FluffyEncounterDetail as b8, type Pokemon as b9, type FireredLeafgreen as bA, type RubySapphire as bB, type GenerationIv as bC, type DiamondPearl as bD, type HeartgoldSoulsilver as bE, type Platinum as bF, type GenerationV as bG, type BlackWhite as bH, type Animated as bI, type GenerationVi as bJ, type OmegarubyAlphasapphire as bK, type XY as bL, type GenerationVii as bM, type GenerationViiIcons as bN, type UltraSunUltraMoon as bO, type GenerationViii as bP, type GenerationViiiIcons as bQ, type StatElement as bR, type PokemonType as bS, type PokemonColor as bT, type PokemonColorName as bU, type PokemonForm as bV, type FormName as bW, type PokemonFormName as bX, type PokemonFormSprites as bY, type PokemonFormType as bZ, type PokemonHabitat as b_, type PokemonAbility as ba, type PokemonGameIndex as bb, type HeldItem as bc, type HeldItemVersionDetail as bd, type MoveElement as be, type VersionGroupDetail as bf, type PastAbility as bg, type PastAbilityAbility as bh, type PastType as bi, type PastTypeType as bj, type PokemonSprites as bk, type Other as bl, type DreamWorld as bm, type Home as bn, type OfficialArtwork as bo, type Showdown as bp, type Versions as bq, type GenerationI as br, type RedBlue as bs, type Yellow as bt, type GenerationIi as bu, type Crystal as bv, type Gold as bw, type Silver as bx, type GenerationIii as by, type Emerald as bz, type AbilityEffectChange as c, type PokemonShape as c0, type AwesomeName as c1, type PokemonShapeName as c2, type PokemonSpecies as c3, type PokemonSpeciesFlavorTextEntry as c4, type FormDescription as c5, type Genus as c6, type PokemonSpeciesName as c7, type PalParkEncounter as c8, type PokedexNumber as c9, type PaginationInput as cA, type PaginatedResult as cB, type Variety as ca, type Region as cb, type RegionName as cc, type Stat as cd, type AffectingMoves as ce, type AffectingMovesDecrease as cf, type AffectingMovesIncrease as cg, type StatAffectingNatures as ch, type StatName as ci, type SuperContestEffect as cj, type SuperContestEffectFlavorTextEntry as ck, type Type as cl, type TypeDamageRelations as cm, type TypeGameIndex as cn, type TypeName as co, type PastDamageRelation as cp, type PastDamageRelationDamageRelations as cq, type TypePokemon as cr, type Version as cs, type VersionName as ct, type VersionGroup as cu, type ListEndpointOptions as cv, type PokeAPIOptions as cw, type Result as cx, PokeJsClientError as cy, PokeJsHttpError as cz, type AbilityEffectEntry as d, type AbilityFlavorTextEntry as e, type AbilityName as f, type AbilityPokemon as g, type BerryFirmness as h, type BerryFirmnessName as i, type BerryFlavor as j, type BerryElement as k, type BerryFlavorName as l, type CharacteristicDescription as m, type ContestEffect as n, type ContestEffectEffectEntry as o, type ContestEffectFlavorTextEntry as p, type ContestType as q, type ContestTypeName as r, type EggGroupName as s, type EncounterCondition as t, type EncounterConditionName as u, type EncounterConditionValue as v, type EncounterConditionValueName as w, type EncounterMethod as x, type EncounterMethodName as y, type EvolutionChain as z };
